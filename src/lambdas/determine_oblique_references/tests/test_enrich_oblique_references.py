...
from lambdas.determine_oblique_references.oblique_references.enrich_oblique_references import (
    enrich_oblique_references,
)

FIXTURE_DIR = Path(__file__).parent.parent.parent.parent.resolve() / "tests/fixtures/"

...
def mock_replace_data(file_data):
    ...
    output_file = f"./tests/test_pipeline_components/output_test_files/case_law_replaced.xml".replace(".xml", "_enriched.xml")
    ...
    output_file = f"./tests/test_pipeline_components/output_test_files/case_law_legislation_replaced.xml".replace(".xml", "_enriched.xml")
    mock_write_file(output_file, file_data_enriched)
    ...
    output_file = f"./tests/test_pipeline_components/output_test_files/case_law_legislation_abbreviations_replaced.xml".replace(".xml", "_enriched.xml")
    mock_write_file(output_file, file_data_enriched)
...
class TestXMLFiles(unittest.TestCase): 
    ...
    def test_case_law(self): 
        with open("./tests/test_pipeline_components/verified_test_files/test_judgment_caselaw_enriched.xml", "r", encoding="utf-8") as file_in:
            verified_file_data = file_in.read()

        with open("./tests/test_pipeline_components/output_test_files/case_law_replaced_enriched.xml", "r", encoding="utf-8") as file_in:
            test_file_data = file_in.read()
        
        assert verified_file_data == test_file_data
    
    def test_legislation(self): 
        with open("./tests/test_pipeline_components/verified_test_files/test_judgment_case_and_leg_enriched.xml", "r", encoding="utf-8") as file_in:
            verified_file_data = file_in.read()

        with open("./tests/test_pipeline_components/output_test_files/case_law_legislation_replaced_enriched.xml", "r", encoding="utf-8") as file_in:
            test_file_data = file_in.read()
    ...
    def test_abbreviations(self): 
        ...
        with open("./tests/test_pipeline_components/output_test_files/case_law_legislation_abbreviations_replaced_enriched.xml", "r", encoding="utf-8") as file_in:
            test_file_data = file_in.read()

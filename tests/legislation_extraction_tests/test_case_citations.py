...
def mock_return_citation(nlp, text, db_conn):
    ...
    return citation_match, family, URItemplate, is_neutral, is_canonical, citation_type, canonical_form
...
class TestCitationProcessor(unittest.TestCase): 
    ...
    def test_citation_matching(self): 
        ...
        citation_match, family, URItemplate, is_neutral, is_canonical, citation_type, canonical_form = mock_return_citation(self.nlp, text, self.db_conn)
...
class TestCitationReplacer(unittest.TestCase): 
    ...
    def test_citation_replacer(self):
        ...
        replacement_string = "<ref type=\"case\" href=\"{}\" isNeutral=\"{}\" canonical=\"{}\" year=\"{}\">{}</ref>".format(URI, is_neutral, corrected_citation, year, citation_match)

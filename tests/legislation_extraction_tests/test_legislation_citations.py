...
import sys
sys.path.append("./")
from database.db_connection import create_connection, close_connection, get_legtitles, get_hrefs
from legislation_processing.legislation_matcher_hybrid import search_for_act, search_for_act_fuzzy, detectCandidate, hybrid, mergedict, detect_year_span, lookup_pipe, leg_pipeline
...
class TestLegislationProcessor(unittest.TestCase): 
    ...
    def test_lookup_pipe(self):
        ...
        assert results == {'Adoption and Children Act 2002': [('Adoption Children Act 2002', 28, 32, 91, 'http://www.legislation.gov.uk/ukpga/2002/38')]}
...
class TestLegislationReplacer(unittest.TestCase): 
    ...
    def test_citation_replacer(self):
        ...
        replacement_string = "<ref type=\"legislation\" href=\"{}\">{}</ref>".format(href, legislation_match)
